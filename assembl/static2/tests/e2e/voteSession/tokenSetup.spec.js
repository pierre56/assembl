...
describe('I can set up a vote phase', () => {
  it(
    ...
    async () => {
      ...
      await page.waitFor(3000);
      await page.click(`input[placeholder='${selectors.voteSession.tokenNamePlaceholder}']`);
      await page.type(`input[placeholder='${selectors.voteSession.tokenNamePlaceholder}']`, 'intitulé du jeton FR');
      await page.click(`input[placeholder='${selectors.voteSession.tokenNumberPlaceholder}']`);
      await page.type(`input[placeholder='${selectors.voteSession.tokenNumberPlaceholder}']`, '0');
      const xpathtest = await page.$x(selectors.voteSession.secondTokenNameXpath);
      await page.click(xpathtest);
      await page.$x(selectors.voteSession.secondTokenNameXpath).type('intitulé du deuxième jeton FR');
      await page.click(`input[placeholder='${selectors.voteSession.secondTokenNumberXpath}']`);
      await page.type(`input[placeholder='${selectors.voteSession.secondTokenNumberXpath}']`, '0');
